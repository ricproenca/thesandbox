    ...
    <div className="bg-white px-8 lg:px-12 py-3 border-b-2 border-teal shadow-[0_2px_8px_rgba(13,45,62,0.06)]">
      <div className="max-w-[1200px] mx-auto flex flex-col gap-2.5">
        <input
          ...
          className="w-full sm:max-w-[300px] px-4 py-2 text-[0.85rem] border-[1.5px] border-border rounded-[8px] bg-white text-navy transition-[border-color,box-shadow] focus-visible:outline-none focus-visible:border-teal focus-visible:shadow-[0_0_0_3px_rgba(28,197,202,0.1)] placeholder:text-muted font-body"
